...
def get_inspector(x, schema=None, tables=None, tables_only=False, target_schema=None):
    if x is None:
    ...
    inspected = ic(c, tables_only=tables_only, tables=tables, target_schema=target_schema)
    if schema:
